...
## 3. Start Posting and Boosting

Introduce yourself with your first post, and include an [#introduction](/tags/introduction) hashtag. Post about whatever you want, and use hashtags to make finding your posts easier. If you see a post you like, boost it. There's no algorithm to amplify selected voices here so we rely on boosting to see what's interesting.
